...
fn syscall_inner(id: usize, args: [usize; 6], cx: &mut TrapContext) -> isize {
    match id {
        ...
        68 => sys_pwrite64(args[0], args[1], args[2], args[3]), // pwrite64
...
fn sys_sendto(sockfd: usize, buf: usize, len: usize, flags: i32, dest_addr: usize, addrlen: usize) -> isize {
    let data = read_user_bytes(buf, len);
    crate::net::poll_net();
    let ret = crate::net::tcp_write(&data);
    crate::net::poll_net();
    ret
}
